  ...
  <Layout>
    <div className="max-w-3xl mx-auto space-y-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="font-serif text-2xl sm:text-3xl font-bold text-forest-950">Terms of Service</h1>
      ...
      <div className="prose prose-sm max-w-none space-y-6 text-earth-700 leading-relaxed">
        <section className="space-y-3">
          <h2 className="font-serif text-xl font-bold text-forest-950">1. Acceptance of Terms</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl font-bold text-forest-950">2. Eligibility and Account Registration</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl font-bold text-forest-950">3. Platform Use and Conduct</h2>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl font-bold text-forest-950">4. Farmer Responsibilities</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl font-bold text-forest-950">5. Orders and Cancellations</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl font-bold text-forest-950">6. Intellectual Property</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl font-bold text-forest-950">7. Disclaimer of Warranties</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl font-bold text-forest-950">8. Limitation of Liability</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl font-bold text-forest-950">9. Modifications to Terms</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl font-bold text-forest-950">10. Contact</h2>
          <p>
