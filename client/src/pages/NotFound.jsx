  ...
  <div className="min-h-screen bg-warm-cream flex items-center justify-center p-6">
    <div className="max-w-md w-full text-center space-y-8">
      ...
      <div className="space-y-3">
        <p className="text-8xl font-extrabold text-primary/10 font-serif select-none leading-none">404</p>
        <h1 className="font-serif text-2xl sm:text-3xl font-bold text-foreground -mt-4">
          Page Not Found
        </h1>
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 h-11 px-6 border-2 border-primary text-primary font-semibold text-sm rounded-xl hover:bg-primary hover:text-primary-foreground transition-colors cursor-pointer"
        >
