    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-warm-cream/60">
        ...
        <div className="flex items-center gap-4">
          <Link to="/privacy-policy" className="hover:text-accent-lime transition-colors">
            Privacy Policy
          </Link>
          <Link to="/terms-of-service" className="hover:text-accent-lime transition-colors">
            Terms of Service
          </Link>
          <span>Map tiles by OpenStreetMap contributors.</span>
        </div>
      </div>
    </div>
  </footer>
